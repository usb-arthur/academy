...
namespace ACADEMY.Application.Implements
{
    public class WatchListService : IWatchListService
    {
        ...
        public WatchListService(IRepository<WatchList, long> watchListRepository, IMapper mapper, IHttpContextAccessor httpContextAccessor, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<ApiResponse<bool>> DeleteByCourseIdAsync(long courseId)
        {
            ...
            if (watchList == null)
            {
                return new ApiErrorResponse<bool>("Khoá học này hiện đang không có trong danh sách yêu thích của bạn", HttpStatusCode.NotFound);
            }
